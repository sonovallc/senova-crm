...
async function testFeature4WithLogin() {
  ...
  try {
    ...
    // Additional test: Wait for create page to load
    console.log('');
    console.log('Additional: Waiting for create page to fully load...');
    await page.waitForURL('**/campaigns/create', { timeout: 10000 }).catch(e => console.log('URL did not change to create'));
    await page.waitForTimeout(3000);
    await page.screenshot({ path: path.join(screenshotDir, '03-create-page-loaded.png'), fullPage: true });
    console.log('Screenshot: Create page (after wait)');
