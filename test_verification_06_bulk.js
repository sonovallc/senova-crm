...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: path.join(screenshotsDir, 'v6-bulk-login-page.png'), fullPage: true });
    console.log('Screenshot saved: v6-bulk-login-page.png\n');
    ...
    await page.screenshot({ path: path.join(screenshotsDir, 'v6-bulk-login-filled.png'), fullPage: true });
    console.log('Screenshot saved: v6-bulk-login-filled.png\n');

    console.log('STEP 3: Click Login button');
    await loginButton.click();
    await page.waitForTimeout(1000);
    await page.screenshot({ path: path.join(screenshotsDir, 'v6-bulk-login-clicked.png'), fullPage: true });
    console.log('Screenshot saved: v6-bulk-login-clicked.png\n');
    ...
    await page.screenshot({ path: path.join(screenshotsDir, 'v6-bulk-dashboard-loaded.png'), fullPage: true });
    console.log('Screenshot saved: v6-bulk-dashboard-loaded.png\n');
    ...
    try {
      await page.screenshot({ path: path.join(screenshotsDir, 'v6-bulk-error.png'), fullPage: true });
      console.log('\nError screenshot saved: v6-bulk-error.png');
    } catch (e) {
