...
async function testWebsitePages(page) {
  ...
  // CORRECTED: Using port 3004 for website pages
  const pages = [
    { url: 'http://localhost:3004/', name: 'homepage' },
    ...
    { url: 'http://localhost:3004/solutions/customer-service', name: 'solutions-customer-service' },
    { url: 'http://localhost:3004/solutions/sales-enablement', name: 'solutions-sales-enablement' },
    { url: 'http://localhost:3004/solutions/marketing-automation', name: 'solutions-marketing-automation' },
    { url: 'http://localhost:3004/solutions/team-collaboration', name: 'solutions-team-collaboration' },
    { url: 'http://localhost:3004/solutions/business-intelligence', name: 'solutions-business-intelligence' },
    { url: 'http://localhost:3004/industries/healthcare', name: 'industries-healthcare' },
    { url: 'http://localhost:3004/industries/finance', name: 'industries-finance' },
    { url: 'http://localhost:3004/industries/retail', name: 'industries-retail' },
    { url: 'http://localhost:3004/industries/technology', name: 'industries-technology' },
    { url: 'http://localhost:3004/privacy-policy', name: 'privacy-policy' },
    { url: 'http://localhost:3004/terms-of-service', name: 'terms-of-service' },
    { url: 'http://localhost:3004/hipaa', name: 'hipaa' },
    { url: 'http://localhost:3004/security', name: 'security' },
    { url: 'http://localhost:3004/compliance', name: 'compliance' },
    { url: 'http://localhost:3004/blog', name: 'blog' },
    { url: 'http://localhost:3004/case-studies', name: 'case-studies' },
    { url: 'http://localhost:3004/roi-calculator', name: 'roi-calculator' },
    { url: 'http://localhost:3004/docs', name: 'docs' }
  ];
...
async function testDashboard(browser) {
  ...
  // Login first - CORRECTED: Using port 3004
  ...
  // CORRECTED: Using port 3004 for all dashboard pages
  const dashboardPages = [
    { url: 'http://localhost:3004/dashboard', name: 'dashboard-home' },
    { url: 'http://localhost:3004/dashboard/contacts', name: 'contacts' },
    { url: 'http://localhost:3004/dashboard/inbox', name: 'inbox' },
    { url: 'http://localhost:3004/dashboard/objects', name: 'objects' },
    { url: 'http://localhost:3004/dashboard/settings', name: 'settings' },
    { url: 'http://localhost:3004/dashboard/closebot', name: 'closebot' },
    { url: 'http://localhost:3004/dashboard/calendar', name: 'calendar' },
    { url: 'http://localhost:3004/dashboard/email-templates', name: 'email-templates' },
    { url: 'http://localhost:3004/dashboard/campaigns', name: 'campaigns' },
    { url: 'http://localhost:3004/dashboard/autoresponders', name: 'autoresponders' },
    { url: 'http://localhost:3004/login', name: 'login-page' }
  ];
...
async function testCORS(browser) {
  ...
  // Login - CORRECTED: Using port 3004
  await page.goto('http://localhost:3004/login', { timeout: 60000 });
  await page.fill('input[type="email"]', 'jwoodcapital@gmail.com');
  await page.fill('input[type="password"]', 'D3n1w3n1!');
  await page.click('button[type="submit"]');
  ...
  // Test Inbox API
  console.log('\nTesting Inbox API...');
  await page.goto('http://localhost:3004/dashboard/inbox', { timeout: 30000 });
  await page.waitForTimeout(5000);
...
async function testMobileNavigation(browser) {
  ...
  // CORRECTED: Using port 3004
  await websitePage.goto('http://localhost:3004/', { timeout: 60000 });
  ...
  // CORRECTED: Using port 3004
  await dashboardPage.goto('http://localhost:3004/login', { timeout: 60000 });
...
async function main() {
  ...
  console.log('Frontend Port: 3004');
