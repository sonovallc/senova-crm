...
(async () => {
  ...
  try {
    ...
    await page.locator('button:has-text("Next")').first().click();
    await page.waitForTimeout(2000);
    await page.screenshot({ path: 'screenshots/step8-duplicates-loading.png', fullPage: true });
    console.log('Waiting for duplicate validation to complete...');
    ...
    await page.waitForTimeout(2000);
    await page.screenshot({ path: 'screenshots/step8-duplicates-ready.png', fullPage: true });
    console.log('PASS: Duplicates page ready');
    ...
    console.log('Success message:', pageText.match(/imported|success|complete/i)?.[0] || 'Found');
