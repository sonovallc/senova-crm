...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/nav-test-01-dashboard.png', fullPage: true });
    console.log('Screenshot: nav-test-01-dashboard.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-02-email-section.png', fullPage: true });
    console.log('Screenshot: nav-test-02-email-section.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-03-compose.png', fullPage: true });
    console.log('Screenshot: nav-test-03-compose.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-04-inbox.png', fullPage: true });
    console.log('Screenshot: nav-test-04-inbox.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-05-templates.png', fullPage: true });
    console.log('Screenshot: nav-test-05-templates.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-06-campaigns.png', fullPage: true });
    console.log('Screenshot: nav-test-06-campaigns.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-07-autoresponders.png', fullPage: true });
    console.log('Screenshot: nav-test-07-autoresponders.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-08-mailgun.png', fullPage: true });
    console.log('Screenshot: nav-test-08-mailgun.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-09-closebot.png', fullPage: true });
    console.log('Screenshot: nav-test-09-closebot.png\n');
    ...
    await page.screenshot({ path: 'screenshots/nav-test-10-other-links.png', fullPage: true });
    console.log('Screenshot: nav-test-10-other-links.png\n');
    
    console.log('COMPREHENSIVE NAVIGATION TEST COMPLETE');
    
  } catch (error) {
    console.error('ERROR:', error.message);
    await page.screenshot({ path: 'screenshots/nav-test-error.png', fullPage: true });
  } finally {
    await browser.close();
  }
})();
