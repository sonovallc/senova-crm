...
async function run() {
  console.log('=== FINAL PRODUCTION VERIFICATION TEST (With Extended Timeouts) ===\n');
  console.log('Testing after complete container rebuild...\n');
  console.log('NOTE: Next.js dev mode is SLOW - using 2-minute timeouts\n');
  ...
  try {
    // LOGIN
    console.log('Step 1: Login (this may take 30-60 seconds on first load)...');
    await page.goto('http://localhost:3004/login', { waitUntil: 'domcontentloaded', timeout: 120000 });
    console.log('   Login page loaded, waiting for it to be ready...');
    ...
    console.log('TEST 1: Campaigns Page (CORS Test) - may take 30-60 seconds...');
    const corsErrorsBefore = results.corsErrors.length;

    await page.goto('http://localhost:3004/dashboard/email/campaigns', { waitUntil: 'domcontentloaded', timeout: 120000 });
    ...
    console.log('TEST 2: Autoresponders Page (CORS Test) - may take 30-60 seconds...');
    const corsErrorsBefore2 = results.corsErrors.length;

    await page.goto('http://localhost:3004/dashboard/email/autoresponders', { waitUntil: 'domcontentloaded', timeout: 120000 });
    console.log('   Page loaded, waiting for data...');
    await page.waitForTimeout(5000);
    ...
    await page.goto('http://localhost:3004/dashboard/inbox', { waitUntil: 'domcontentloaded', timeout: 120000 });
    await page.waitForTimeout(3000);
    ...
    await page.goto('http://localhost:3004/dashboard/settings/integrations/mailgun', { waitUntil: 'domcontentloaded', timeout: 120000 });
    await page.waitForTimeout(3000);
    ...
    await page.goto('http://localhost:3004/dashboard/email/compose', { waitUntil: 'domcontentloaded', timeout: 120000 });
    await page.waitForTimeout(3000);
    ...
    await page.goto('http://localhost:3004/dashboard/email/templates', { waitUntil: 'domcontentloaded', timeout: 120000 });
    await page.waitForTimeout(3000);
  ...
  const jsonPath = path.join(screenshotDir, 'test-results.json');
