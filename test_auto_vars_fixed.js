...
(async () => {
  ...
  try {
    ...
    if (variablesButtons > 0) {
      ...
      console.log('  contact_name: ' + (contactName > 0 ? 'YES' : 'NO'));
      console.log('  first_name: ' + (firstName > 0 ? 'YES' : 'NO'));
      console.log('  last_name: ' + (lastName > 0 ? 'YES' : 'NO'));
      console.log('  email: ' + (email > 0 ? 'YES' : 'NO'));
      console.log('  company: ' + (company > 0 ? 'YES' : 'NO'));
      console.log('  phone: ' + (phone > 0 ? 'YES' : 'NO'));
      console.log('');
